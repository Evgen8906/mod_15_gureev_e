...
class NavigationTest(BaseCase):
    ...
    def test_05_change_region(self):
        ...
        price_one = self.get_text('//*[@id="products"]/article[1]/a/div[2]/p[3]/span[2]')
        ...
        price_two = self.get_text('//*[@id="products"]/article[1]/a/div[2]/p[3]/span[2]')
        # английский текст не должен совпадать с русским
        self.assert_equal(eng_text, ru_text)
        self.assert_not_equal(price_one, price_two)
